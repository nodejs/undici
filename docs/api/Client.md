...
* **bodyTimeout** `number | null` (optional) - Default: `120e` - The timeout after which a request will time out, in milliseconds. Monitors time between receiving body data. Use `0` to disable it entirely. Defaults to 120 seconds.
* **headersTimeout** `number | null` (optional) - Default: `120e` - The amount of time the parser will wait to receive the complete HTTP headers. Defaults to 120 seconds.
