...
* **webSocket** `WebSocketOptions` (optional) - WebSocket-specific configuration options.
  * **perMessageDeflate** `boolean` (optional) - Default: `true` - Whether the WebSocket client should negotiate [permessage-deflate](https://datatracker.ietf.org/doc/html/rfc7692) support. Set to `false` to disable permessage-deflate.
