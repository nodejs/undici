...
├────────────────────────┼─────────┼────────────────────┼────────────┼─────────────────────────┤
│  'node-fetch'          │ 65      │ '4933.54 req/sec'  │ '± 2.92 %' │ '-'                     │
│  'axios'               │ 35      │ '5239.83 req/sec'  │ '± 2.92 %' │ '+ 6.21 %'              │
│  'undici - fetch'      │ 90      │ '5545.99 req/sec'  │ '± 2.98 %' │ '+ 12.41 %'             │
│  'http - no keepalive' │ 25      │ '5737.01 req/sec'  │ '± 2.74 %' │ '+ 16.29 %'             │
│  'request'             │ 80      │ '6068.73 req/sec'  │ '± 2.92 %' │ '+ 23.01 %'             │
│  'got'                 │ 60      │ '6320.02 req/sec'  │ '± 2.94 %' │ '+ 28.10 %'             │
│  'superagent'          │ 45      │ '7429.98 req/sec'  │ '± 2.87 %' │ '+ 50.60 %'             │
│  'http - keepalive'    │ 75      │ '9414.03 req/sec'  │ '± 2.90 %' │ '+ 90.82 %'             │
│  'undici - pipeline'   │ 70      │ '13004.98 req/sec' │ '± 2.94 %' │ '+ 163.60 %'            │
│  'undici - request'    │ 101     │ '17121.91 req/sec' │ '± 3.10 %' │ '+ 247.05 %'            │
│  'undici - stream'     │ 80      │ '19002.37 req/sec' │ '± 2.89 %' │ '+ 285.17 %'            │
│  'undici - dispatch'   │ 85      │ '20429.51 req/sec' │ '± 2.94 %' │ '+ 314.09 %'            │
└────────────────────────┴─────────┴────────────────────┴────────────┴─────────────────────────┘
```
...
│  Tests                 │ Samples │ Result            │ Tolerance  │ Difference with slowest │
├────────────────────────┼─────────┼───────────────────┼────────────┼─────────────────────────┤
│  'undici - fetch'      │ 40      │ '3690.39 req/sec' │ '± 2.96 %' │ '-'                     │
│  'native - http2'      │ 35      │ '4493.40 req/sec' │ '± 2.94 %' │ '+ 21.76 %'             │
│  'undici - pipeline'   │ 50      │ '5853.77 req/sec' │ '± 2.89 %' │ '+ 58.62 %'             │
│  'undici - request'    │ 50      │ '7167.91 req/sec' │ '± 2.94 %' │ '+ 94.23 %'             │
│  'undici - stream'     │ 50      │ '7898.26 req/sec' │ '± 2.98 %' │ '+ 114.02 %'            │
│  'undici - dispatch'   │ 45      │ '8148.07 req/sec' │ '± 2.93 %' │ '+ 120.79 %'            │
└────────────────────────┴─────────┴───────────────────┴────────────┴─────────────────────────┘
```
