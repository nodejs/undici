...
├────────────────────────┼─────────┼────────────────────┼────────────┼─────────────────────────┤
│  'node-fetch'          │ 35      │ '4913.41 req/sec'  │ '± 2.86 %' │ '-'                     │
│  'axios'               │ 35      │ '5298.37 req/sec'  │ '± 2.93 %' │ '+ 7.83 %'              │
│  'undici - fetch'      │ 60      │ '5559.98 req/sec'  │ '± 2.96 %' │ '+ 13.16 %'             │
│  'http - no keepalive' │ 35      │ '5880.68 req/sec'  │ '± 2.86 %' │ '+ 19.69 %'             │
│  'request'             │ 75      │ '6234.67 req/sec'  │ '± 2.97 %' │ '+ 26.89 %'             │
│  'got'                 │ 45      │ '6257.96 req/sec'  │ '± 2.89 %' │ '+ 27.36 %'             │
│  'superagent'          │ 55      │ '7598.70 req/sec'  │ '± 2.91 %' │ '+ 54.65 %'             │
│  'http - keepalive'    │ 70      │ '8971.76 req/sec'  │ '± 2.99 %' │ '+ 82.60 %'             │
│  'undici - pipeline'   │ 65      │ '13525.33 req/sec' │ '± 2.86 %' │ '+ 175.27 %'            │
│  'undici - request'    │ 70      │ '16446.28 req/sec' │ '± 2.88 %' │ '+ 234.72 %'            │
│  'undici - stream'     │ 75      │ '18400.74 req/sec' │ '± 2.94 %' │ '+ 274.50 %'            │
└────────────────────────┴─────────┴────────────────────┴────────────┴─────────────────────────┘
```
