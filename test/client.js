...
test('basic get with custom global.reset=true & request.reset=false,undefined', (t) => {
  let called = 0
  t.plan(26)
...
test('basic get with custom global.reset=false & request.reset=true,undefined', (t) => {
  let called = 0
  t.plan(26)
...
test('basic get with custom global.reset=false & request.reset=true', (t) => {
  t.plan(26)
...
test('basic get with custom client.reset=true & request.reset=false', (t) => {
  t.plan(26)
...
test('basic get with custom client.reset=true', (t) => {
  t.plan(26)
