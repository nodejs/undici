...
expectType<HeadersIterator<string>>(headers.keys())
expectType<HeadersIterator<string>>(headers.values())
expectType<HeadersIterator<[string, string]>>(headers.entries())
