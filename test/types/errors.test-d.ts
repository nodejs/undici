...
expectAssignable<errors.UndiciError>(new errors.RequestContentLengthError())
expectAssignable<errors.RequestContentLengthError>(new errors.RequestContentLengthError())
expectAssignable<'RequestContentLengthError'>(new errors.RequestContentLengthError().name)
expectAssignable<'UND_ERR_REQUEST_CONTENT_LENGTH_MISMATCH'>(new errors.RequestContentLengthError().code)

expectAssignable<errors.UndiciError>(new errors.ResponseContentLengthError())
expectAssignable<errors.ResponseContentLengthError>(new errors.ResponseContentLengthError())
expectAssignable<'ResponseContentLengthError'>(new errors.ResponseContentLengthError().name)
expectAssignable<'UND_ERR_RESPONSE_CONTENT_LENGTH_MISMATCH'>(new errors.ResponseContentLengthError().code)
