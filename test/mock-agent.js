...
const { request, setGlobalDispatcher, MockAgent, Agent, MockMissingHeader } = require('..')
...
test('MockAgent - intercept only on missing header', async (t) => {
  t.plan(3)
  ...
  mockPool.intercept({
    ...
    method: 'GET',
    headers: {
      authorization: MockMissingHeader
    }
  }).reply(200, 'foo').times(2)
