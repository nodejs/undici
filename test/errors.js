...
const scenarios = [
  ...
  createScenario(errors.RequestContentLengthError, 'Request body length does not match content-length header', 'RequestContentLengthError', 'UND_ERR_REQUEST_CONTENT_LENGTH_MISMATCH'),
  createScenario(errors.ResponseContentLengthError, 'Response body length does not match content-length header', 'ResponseContentLengthError', 'UND_ERR_RESPONSE_CONTENT_LENGTH_MISMATCH'),
