...
function write (client, request) {
  ...
  if (request.body && (method === 'HEAD' || method === 'GET')) {
    ...
    // to parse the body as a request and provide two responses and corrupt
    // client state. Indicate that the connection should be reset once a
