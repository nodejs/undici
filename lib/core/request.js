  ...
  constructor (origin, {
    ...
    if (body == null) {
      ...
      if (!isUndiciFormData(body)) {
        throw new InvalidArgumentError('body must be a FormData created by this version of undici; FormData from other sources, such as the global FormData, is not supported')
      }
      this.body = body
