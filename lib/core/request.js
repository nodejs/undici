...
class Request {
  ...
  onConnect (resume) {
    ...
    if (typeof this[kHandler].onConnect !== 'function') {
  ...
  onHeaders (statusCode, headers, resume) {
    ...
    if (typeof this[kHandler].onHeaders !== 'function') {
  ...
  onBody (chunk, offset, length) {
    ...
    if (typeof this[kHandler].onData !== 'function') {
  ...
  onComplete (trailers) {
    ...
    if (typeof this[kHandler].onComplete !== 'function') {
  ...
  onError (err) {
    ...
    if (typeof this[kHandler].onError !== 'function') {
