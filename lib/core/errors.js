...
class InvalidArgumentError extends UndiciError {
  constructor(message) {
    ...
    this.message =
      message || /* istanbul ignore next */ 'Invalid Argument Error'
...
class InvalidReturnValueError extends UndiciError {
  constructor(message) {
    ...
    this.message =
      message || /* istanbul ignore next */ 'Invalid Return Value Error'
...
class ContentLengthMismatchError extends UndiciError {
  constructor(message) {
    ...
    this.message =
      message ||
      /* istanbul ignore next */ 'Request body length does not match content-length header'
...
class TrailerMismatchError extends UndiciError {
  constructor(message) {
    ...
    this.message =
      message ||
      /* istanbul ignore next */ 'Trailers does not match trailer header'
...
class ClientDestroyedError extends UndiciError {
  constructor(message) {
    ...
    this.message =
      message || /* istanbul ignore next */ 'The client is destroyed'
