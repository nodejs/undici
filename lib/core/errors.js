...
const kDNSFilterError = Symbol.for('undici.error.UND_ERR_DNS_FILTER')
class DNSFilterError extends UndiciError {
  constructor (message) {
    super(message)
    this.name = 'DNSFilterError'
    this.message = message || 'DNS address rejected by filter'
    this.code = 'UND_ERR_DNS_FILTER'
  }

  static [Symbol.hasInstance] (instance) {
    return instance && instance[kDNSFilterError] === true
  }
...
const kMaxRedirectsError = Symbol.for('undici.error.UND_ERR_REDIRECT_MAX')
class MaxRedirectsError extends UndiciError {
  constructor (message) {
    super(message)
    this.name = 'MaxRedirectsError'
    this.message = message || 'max redirects'
    this.code = 'UND_ERR_REDIRECT_MAX'
  }

  static [Symbol.hasInstance] (instance) {
    return instance && instance[kMaxRedirectsError] === true
  }

  get [kMaxRedirectsError] () {
    return true
  }
}
