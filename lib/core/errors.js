...
class ConnectTimeoutError extends UndiciError {
  constructor (message) {
    ...
    this.message = message || /* istanbul ignore next */ 'Connect Timeout Error'
...
class HeadersTimeoutError extends UndiciError {
  constructor (message) {
    ...
    this.message = message || /* istanbul ignore next */ 'Headers Timeout Error'
...
class HeadersOverflowError extends UndiciError {
  constructor (message) {
    ...
    this.message = message || /* istanbul ignore next */ 'Headers Overflow Error'
...
class BodyTimeoutError extends UndiciError {
  constructor (message) {
    ...
    this.message = message || /* istanbul ignore next */ 'Body Timeout Error'
