...
const channels = {
  ...
  // Fetch channels
  start: diagnosticsChannel.channel('undici:fetch:start'),
  end: diagnosticsChannel.channel('undici:fetch:end'),
  asyncStart: diagnosticsChannel.channel('undici:fetch:asyncStart'),
  asyncEnd: diagnosticsChannel.channel('undici:fetch:asyncEnd'),
