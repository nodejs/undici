...
function getServerName (host) {
  ...
  if (servername.startsWith('[')) {
    ...
    servername = idx !== -1 ? servername.substr(1, idx - 1) /* istanbul ignore next */ : servername
  } else {
...
module.exports = {
  ...
  bodyLength,
  isBuffer,
  queueMicrotask: global.queueMicrotask /* istanbul ignore next */ || (cb => Promise.resolve()
    .then(cb)
