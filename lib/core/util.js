...
function isIterable (fn) {
  return !!(fn != null && (typeof fn[Symbol.iterator] === 'function' || typeof fn[Symbol.asyncIterator] === 'function'))
}

function isGenerator (fn) {
  return !!(fn != null && typeof fn === 'function' &&
    (fn.constructor.name === 'GeneratorFunction' || fn.constructor.name === 'AsyncGeneratorFunction'))
}
