...
async function writeIterable (client, request, socket, contentLength, header, expectsPayload) {
  ...
  assert(contentLength !== 0 || !client.running, 'iterable body cannot be pipelined')
  ...
  try {
    ...
    const err = contentLength !== null && bytesWritten !== contentLength ? new ContentLengthMismatchError() : undefined
