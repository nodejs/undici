...
const NodeHTTPParser = require('../node/http-parser')
...
class Parser extends HTTPParser {
  constructor (client, socket) {
    super({ maxHeaderSize: client[kMaxHeadersSize] })
  ...
  [NodeHTTPParser.kOnHeaders] (rawHeaders) {
    /* istanbul ignore next: difficult to make a test case for */
    if (this.paused) {
      this.queue.push([this[NodeHTTPParser.kOnHeaders], rawHeaders])
      return
    }
  ...
  [NodeHTTPParser.kOnExecute] (ret, currentBuffer) {
    if (this.paused) {
      this.queue.push([this[NodeHTTPParser.kOnExecute], ret])
      return
    }
  ...
  [NodeHTTPParser.kOnHeadersComplete] (versionMajor, versionMinor, rawHeaders, method,
    url, statusCode, statusMessage, upgrade, shouldKeepAlive) {
    /* istanbul ignore next: difficult to make a test case for */
    if (this.paused) {
      this.queue.push([this[NodeHTTPParser.kOnHeadersComplete], versionMajor, versionMinor, rawHeaders, method,
        url, statusCode, statusMessage, upgrade, shouldKeepAlive])
      return
    }
  ...
  [NodeHTTPParser.kOnBody] (chunk, offset, length) {
    if (this.paused) {
      this.queue.push([this[NodeHTTPParser.kOnBody], chunk, offset, length])
      return
    }
  ...
  [NodeHTTPParser.kOnMessageComplete] () {
    /* istanbul ignore next: difficult to make a test case for */
    if (this.paused) {
      this.queue.push([this[NodeHTTPParser.kOnMessageComplete]])
      return
    }
