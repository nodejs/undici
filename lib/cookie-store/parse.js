...
const { maxExpiresMs } = require('./constants')
...
function parseUnparsedAttributes (unparsedAttributes, cookieAttributeList = {}) {
  ...
  if (attributeNameLowercase === 'expires') {
    ...
    let expiryTime = new Date(attributeValue).getTime() / 1000
    ...
    if (!Number.isNaN(expiryTime)) {
      ...
      expiryTime = Math.max(expiryTime, Date.now() / 1000)
      ...
      cookieAttributeList.Expires = Math.floor(expiryTime)
    }
  }
