...
const IMF_DAYS = /** @type {const} */ (['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'])
const IMF_SPACES = /** @type {const} */ ([4, 7, 11, 16, 25])
const IMF_MONTHS = /** @type {const} */ (['jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dec'])
const IMF_COLONS = /** @type {const} */ ([19, 22])

const ASCTIME_SPACES = /** @type {const} */ ([3, 7, 10, 19])

const RFC850_DAYS = /** @type {const} */ (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'])
