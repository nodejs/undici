...
class MockAgent extends Dispatcher {
  ...
  dispatch (opts, handler) {
    ...
    if (dispatchOpts.allowH2 === false && typeof dispatchOpts.origin === 'string') {
      const originKey = Agent.getOriginKey(dispatchOpts.origin, false)
      let dispatcher = this[kMockAgentGet](originKey)

      if (!dispatcher) {
        dispatcher = this[kFactory](dispatchOpts.origin, { ...this[kOptions], allowH2: false })
        this[kMockAgentSet](originKey, dispatcher)
      }

      dispatcher[kDispatches] = baseDispatcher[kDispatches]
