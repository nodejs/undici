...
function mockDispatch (opts, handler) {
  ...
  if (mockDispatch[kMockCallHistory] !== undefined) {
    // add call history log even on intercepted calls when mockScope.registerCallHistory was called
    mockDispatch[kMockCallHistory][kMockCallHistoryAddLog](opts)
  }
