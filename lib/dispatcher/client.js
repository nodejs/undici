...
class Client extends DispatcherBase {
  ...
  constructor (url, {
    ...
    if (bodyIdleTimeout != null && (!Number.isInteger(bodyIdleTimeout) || bodyIdleTimeout < 0)) {
      throw new InvalidArgumentError('bodyIdleTimeout must be a positive integer or zero')
    }
    ...
    this[kBodyIdleTimeout] = bodyIdleTimeout != null ? bodyIdleTimeout : 0
