...
class Client extends DispatcherBase {
  ...
  constructor (url, {
    ...
    // Leave kPipelining null when unset so getPipelining() picks up the
    // protocol-specific default from kHTTPContext (1 for h1, Infinity for h2)
    // once the connection is established. See #4143.
    this[kPipelining] = pipelining != null ? pipelining : null
