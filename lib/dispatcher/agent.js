...
class Agent extends DispatcherBase {
  constructor ({ factory = defaultFactory, origins = Infinity, connect, ...options } = {}) {
    ...
    if (Number.isNaN(origins) || origins <= 0) {
    ...
    this[kOptions] = { ...util.deepClone(options), origins, connect }
  ...
  [kDispatch] (opts, handler) {
    ...
    if (this[kOrigins].size >= this[kOptions].origins && !this[kOrigins].has(key)) {
