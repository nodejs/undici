...
class Client extends EventEmitter {
  constructor (url, {
    ...
    if (busyTimeout != null && !Number.isFinite(busyTimeout)) {
      throw new InvalidArgumentError('invalid busyTimeout')
    }
    ...
    this[kBusyTimeout] = busyTimeout == null ? 10e3 : busyTimeout
    this[kClosed] = false
  ...
  get busy () {
    ...
    if (this.running && Date.now() - this[kRequestTime] > this[kBusyTimeout]) {
      return true
    }
