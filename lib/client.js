...
function addListener (obj, name, cb) {
...
function removeAllListeners (obj) {
  for (const [name, listener] of obj[kListeners]?.splice(0) ?? []) {
...
class Client extends DispatcherBase {
  ...
  constructor (url, {
    ...
    this[kMaxConcurrentStreams] = maxConcurrentStreams ?? 100 // Max peerConcurrentStreams for a Node h2 server
