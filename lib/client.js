...
try {
  ...
  channels.dispatch = diagnosticsChannel.channel('undici:request:dispatch')
} catch  {
  channels.dispatch = { hasSubcribers: false }
}
...
class Client extends Dispatcher {
  ...
  dispatch (opts, handler) {
    ...
    try {
      ...
      if (channels.dispatch.hasSubscribers) {
        channels.dispatch.publish(opts)
      }
