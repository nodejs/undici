...
class Client extends EventEmitter {
  ...
  dispatch (opts, handler) {
    ...
    request._onConnect = handler.onConnect
    request._onUpgrade = handler.onUpgrade
    request._onInfo = handler.onInfo
    request._onHeaders = handler.onHeaders
    request._onData = handler.onData
    request._onComplete = handler.onComplete
    request._onError = handler.onError
