...
class Parser extends HTTPParser {
  ...
  [HTTPParser.kOnHeaders] (rawHeaders) {
    ...
    assert(!client[kHeadersTimeout] || socket[kWriting || this.timeout])
    ...
    if (headers) {
      Array.prototype.push.apply(headers, rawHeaders)
    } else {
  ...
  [HTTPParser.kOnHeadersComplete] (versionMajor, versionMinor, rawHeaders, method,
    ...
    console.error('kOnHeadersComplete')
  ...
  [HTTPParser.kOnMessageComplete] () {
    console.error('kOnMessageComplete')
    ...
    console.error('onMessageComplete')
