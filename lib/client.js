...
class Client extends EventEmitter {
  ...
  dispatch (opts, handler) {
    ...
    request._onConnect = handler._onConnect
    request._onUpgrade = handler._onUpgrade
    request._onInfo = handler._onInfo
    request._onHeaders = handler._onHeaders
    request._onData = handler._onData
    request._onComplete = handler._onComplete
    request._onError = handler._onError
