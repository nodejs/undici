...
try {
  ...
  channels.write = diagnosticsChannel.channel('undici:client:write')
  channels.connect = diagnosticsChannel.channel('undici:client:connect')
  channels.connectError = diagnosticsChannel.channel('undici:client:connect:error')
  channels.connected = diagnosticsChannel.channel('undici:client:connected')
} catch {
  channels.write = { hasSubscribers: false }
  channels.connect = { hasSubscribers: false }
...
function write (client, request) {
  ...
  if (channels.write.hasSubscribers) {
    channels.write.publish({ request, headers: header, socket })
  }
