...
const wasm_on_header_field = (p, at, len) => {
  currentParser[kOnHeaderField](inst.exports.memory.buffer, at, len)
  return 0
}

const wasm_on_header_value = (p, at, len) => {
  currentParser[kOnHeaderValue](inst.exports.memory.buffer, at, len)
  return 0
}
...
const wasm_on_message_complete = (p) => {
  currentParser[kOnMessageComplete]()
  return 0
}
