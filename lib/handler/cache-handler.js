...
class CacheHandler {
  ...
  onResponseStart (
    ...
    if (!canCacheResponse(this.#cacheType, statusCode, resHeaders, cacheControlDirectives, this.#cacheByDefault)) {
      return downstreamOnHeaders()
    }
 ...
 * @param {number | undefined} cacheByDefault
 */
function canCacheResponse (cacheType, statusCode, resHeaders, cacheControlDirectives, cacheByDefault) {
