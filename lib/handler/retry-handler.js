...
class RetryHandler {
  ...
  onResponseStart (controller, statusCode, headers, statusMessage) {
    ...
    if (this.headersSent) {
      ...
      // If no content range
      if (!contentRange) {
        const err = new RequestRetryError('Content-Range mismatch', statusCode, {
          headers,
          data: { count: this.retryCount }
        })
      ...
      if (this.etag != null && this.etag !== headers.etag) {
        const err = new RequestRetryError('ETag mismatch', statusCode, {
          headers,
          data: { count: this.retryCount }
        })
