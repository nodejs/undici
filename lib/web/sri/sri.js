...
const getSRIHashAlgorithmIndex = /** @type {GetSRIHashAlgorithmIndex} */ (Map.prototype.get.bind(
  new Map(validSRIHashAlgorithmTokenSet.map((alg, index) => [alg, index]))))
...
const isValidSRIHashAlgorithm = /** @type {IsValidSRIHashAlgorithm} */ (
  Set.prototype.has.bind(new Set(validSRIHashAlgorithmTokenSet))
)
 ...
 */
const bytesMatch = crypto === undefined
