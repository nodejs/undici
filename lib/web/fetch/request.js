...
function cloneRequest (request) {
  ...
  // Undici note: in #http-network-or-cache-fetch: "Implementations
  // are encouraged to avoid teeing request’s body’s stream when
  // request’s body’s source is null as only a single body is needed..."
