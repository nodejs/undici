...
function responseLocationURL (response, requestFragment) {
  ...
  // `Location` and response’s header list. Multiple field lines are not a
  // single URL, even though Headers.get() exposes them as a combined value.
  if (response.headersList.hasDuplicateLocation) {
    throw new TypeError('Multiple Location headers')
  }
