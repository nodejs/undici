...
function isTraversableNavigable (navigable) {
  // Node.js is not a browser environment, there is no traversable navigable
  // that can prompt the user for credentials. Returning true would cause
  // infinite retry loops on 401 responses.
  return false
}
