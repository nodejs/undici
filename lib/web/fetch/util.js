...
function isOriginPotentiallyTrustworthy (origin) {
  ...
  if (originAsURL.hostname === 'localhost' || originAsURL.hostname.includes('localhost.')) {
    return true
  }

  //    origin’s host ends with ".localhost" or ".localhost."
  if (originAsURL.hostname.endsWith('.localhost')) {
    return true
  }

  // 6. If origin’s scheme is "file", return "Potentially Trustworthy".
  if (originAsURL.protocol === 'file:') {
    return true
  }
  ...
  // 8. If origin has been configured as a trustworthy origin, retur
