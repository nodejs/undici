...
class HeadersList {
  ...
  constructor (init) {
    if (init instanceof HeadersList) {
      ...
      this.hasDuplicateLocation = init.hasDuplicateLocation
    } else {
  ...
  clear () {
    ...
    this.sortedMap = null
    this.cookies = null
    this.hasDuplicateLocation = false
  }
  ...
  append (name, value, isLowerCase) {
    ...
    if (exists) {
      if (lowercaseName === 'location') {
        this.hasDuplicateLocation = true
      }
  ...
  set (name, value, isLowerCase) {
    ...
    if (lowercaseName === 'set-cookie') {
      this.cookies = [value]
    } else if (lowercaseName === 'location') {
      this.hasDuplicateLocation = false
    }
