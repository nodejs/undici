...
function fetching ({
  ...
  mainFetch(fetchParams, false, true)
...
async function mainFetch (fetchParams, recursive, _closeFetchParamsControllerOnError) {
  try {
    ...
    if (_closeFetchParamsControllerOnError) {
...
function httpRedirectFetch (fetchParams, response) {
  ...
  return mainFetch(fetchParams, true, false)
}
