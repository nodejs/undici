...
function subscribersCheck () {
  return channels.tracingChannel.start.hasSubscribers ||
  channels.tracingChannel.end.hasSubscribers ||
  channels.tracingChannel.asyncStart.hasSubscribers ||
  channels.tracingChannel.asyncEnd.hasSubscribers ||
  channels.tracingChannel.error.hasSubscribers
}
...
function fetch (input, init = {}) {
  ...
  return channels.tracingChannel.tracePromise(async () => {
