...
class WebSocketStream {
  ...
  #onSocketClose () {
    ...
    if (wasClean) {
      ...
      const error = new WebSocketError('unclean close', {
        closeCode: code,
        reason
      })
  ...
  #onFail (reason) {
    ...
    this.#openedPromise.reject(new WebSocketError('socket closed'))
    this.#closedPromise.reject(new WebSocketError('socket closed'))
  }
