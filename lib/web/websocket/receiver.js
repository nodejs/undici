...
class ByteParser extends Writable {
  ...
  #validatePayloadLength () {
    if (this.#maxPayloadSize <= 0 || isControlFrame(this.#info.opcode)) {
      return true
    }

    if (this.#info.compressed) {
      if (this.#info.payloadLength > this.#maxPayloadSize) {
    ...
    if (this.#fragmentsBytes + this.#info.payloadLength > this.#maxPayloadSize) {
      failWebsocketConnection(this.#handler, 1009, 'Payload size exceeds maximum allowed size')
      return false
    }
