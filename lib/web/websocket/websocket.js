...
class WebSocket extends EventTarget {
  ...
  #onConnectionEstablished (response, parsedExtensions) {
    ...
    const parser = new ByteParser(this, this.#handler, parsedExtensions)
    parser.on('drain', onParserDrain.bind(this[kResponse].socket))
    parser.on('error', onParserError.bind(this, this.#handler))
  ...
  #onFail (reason) {
    const { [kController]: controller, [kResponse]: response } = this
  ...
  #onMessage (type, data) {
    ...
    if (this[kReadyState] !== states.OPEN) {
      return
    }
    ...
    fireEvent('message', this, createFastMessageEvent, {
      origin: this[kWebSocketURL].origin,
      data: dataForEvent
    })
  }
...
function onParserDrain (socket) {
  socket.resume()
}

function onParserError (handler, err) {
  let message
  let code
  ...
  closeWebSocketConnection(handler, code)
}
