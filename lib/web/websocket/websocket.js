 ...
 * @property {(reason?: any) => void} onSocketClose
 ...
 * @property {import('../../../index').Agent} agent
 */
...
class WebSocket extends EventTarget {
  ...
  #handler = {
    ...
    onSocketClose: (reason) => this.#onSocketClose(reason),
    onPing: (body) => {
  ...
  constructor (url, protocols = []) {
    ...
    this.#handler.agent = options.dispatcher
