...
class EventSourceStream extends Transform {
  ...
  parseLine (line, event) {
    ...
    if (isFieldName(line, fieldLength, DATA)) {
      ...
      const eventDataSize = this.getEventDataSize(event) + (event.data === undefined ? 0 : 1) + valueBytes
      ...
      this.setEventDataSize(event, eventDataSize)
      return
    }
  ...
  getEventDataSize (event) {
    ...
    return event.data === undefined ? 0 : Buffer.byteLength(event.data)
  }
