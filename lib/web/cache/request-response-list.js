...
class RequestResponseList {
  ...
  constructor (location = ':memory:') {
    ...
    this.#appendQuery = this.#db.prepare('INSERT INTO requestResponseList (request, response, responseFilter, body) VALUES (?, ?, ?, ?)')
    ...
    this.#itemsQuery = this.#db.prepare('SELECT id, request, response, responseFilter, body FROM requestResponseList ORDER BY id')
  }
