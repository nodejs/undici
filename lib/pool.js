...
const { kSize, kConnected, kRunning, kPending, kUrl, kBusy } = require('./core/symbols')
...
class Pool extends Dispatcher {
  constructor (origin, { connections, factory = defaultFactory, connect, tls, socketPath, ...options } = {}) {
    super()
    ...
    this[kOptions] = { ...JSON.parse(JSON.stringify(options)), connect: connect || makeConnect({ tls, socketPath }) }
