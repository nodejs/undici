...
class Pool extends EventEmitter {
  ...
  get busy () {
    // TODO (fix): If all clients are busy we should not require any queued requests
    // in pool i.e:
    //   return this[kConnections] &&
    //          this[kClients].length == this[kConnections] &&
    //          this[kClients].every(({ busy }) => busy)
    // With corresponding kNeedDrain and 'drain' logic.
    // However, this[kPending] > 0 semantics is simpler and faster at the cost of
    // one extra queued request.
