...
class Response {
  ...
  static redirect (url, status = 302) {
    ...
    responseObject[kState].headersList.fastAppend('location', value)
...
function initializeResponse (response, init, body) {
  ...
  if (body) {
    ...
    if (body.type != null && !response[kState].headersList.fastContains('content-type')) {
      response[kState].headersList.fastAppend('content-type', body.type)
    }
  }
}
