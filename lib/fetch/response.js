...
class Response {
  ...
  static redirect (url, status = 302) {
    ...
    responseObject[kState].headersList.lowerCaseAppend('location', value)
...
function initializeResponse (response, init, body) {
  ...
  if (body) {
    ...
    if (body.type != null && !response[kState].headersList.lowerCaseContains('content-type')) {
      response[kState].headersList.lowerCaseAppend('content-type', body.type)
    }
  }
}
