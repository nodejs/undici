...
const { kState, kHeaders, kGuard, kRealm, kType, kResponse, kFormData } = require('./symbols')
...
webidl.converters.FormData = function (V, opts = {}) {
  if (opts.strict !== false && V[kType] !== kFormData) {
    throw webidl.errors.exception({
      header: 'FormData',
      message: `Expected ${V} to be an instance of FormData.`
    })
  }
