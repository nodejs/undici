...
async function fetch (resource, init) {
  ...
  request.client = {
    ...
    globalObject: new ServiceWorkerGlobalScope()
  }
  ...
  const globalObject = request.globalObject
...
function fetching ({ request, processResponse, processResponseDone }) {
  ...
  if (request.window === 'client') {
    request.window = request.client instanceof Window ? request.client : 'no-window'
  }
