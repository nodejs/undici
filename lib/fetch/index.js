...
async function schemeFetch (fetchParams) {
  ...
  switch (scheme) {
    ...
    case 'blob:': {
      ...
      fetchParams.controller.on('terminated', onRequestAborted)
      ...
      fetchParams.controller.off('terminated', onRequestAborted)
      ...
      function onRequestAborted () {
        ...
        return makeNetworkError(fetchParams.controller.terminated.reason)
      }
    }
    case 'data:': {
...
async function httpNetworkOrCacheFetch (
  ...
  if (response.status === 407) {
    ...
    if (fetchParams.controller.terminated) {
      // 1. Let aborted be the termination’s aborted flag.
      const aborted = fetchParams.controller.terminated.aborted
...
async function httpNetworkFetch (
  ...
  const cancelAlgorithm = () => {
    fetchParams.controller.terminate({ aborted: true })
  }
  ...
  fetchParams.controller.resume = async () => {
    ...
    while (true) {
      ...
      if (bytes instanceof Error) {
        fetchParams.controller.terminate({ reason: bytes })
        return
      }
    ...
    return new Promise((resolve, reject) => fetchParams.controller.dispatcher.dispatch(
      ...
      },
      {
        ...
        onError (error) {
          ...
          fetchParams.controller.terminate({ reason: error })
