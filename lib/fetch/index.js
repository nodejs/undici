...
async function fetch (resource, init) {
  ...
  const processResponse = (response) => {
    ...
    // TODO: If network error we need to terminate fetch somewhere?
...
function abortFetch (p, request, responseObject) {
  ...
  // body with error.
  if (response.body != null && context.connection) {
    context.connection.error(error)
  }
}
...
async function httpNetworkOrCacheFetch (
  ...
  if (
    ...
    // TODO: The spec doesn't specify this but we need to cancel
    ...
    context.dispatcher.dispatch(
      ...
      },
      {
        ...
        onData (chunk) {
          ...
          timingInfo.decodedBodySize += bytes.byteLength
