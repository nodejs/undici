    ...
    return new Promise((resolve, reject) => agent.dispatch(
      ...
      },
      {
        ...
        onHeaders (status, rawHeaders, resume, statusText) {
          ...
          if (Array.isArray(rawHeaders)) {
            for (let n = 0; n < rawHeaders.length; n += 2) {
              headersList.append(rawHeaders[n].toString('latin1'), rawHeaders[n + 1].toString('latin1'))
            }
            ...
            hasLocation = headersList.contains('location')
          } else {
            ...
            hasLocation = rawHeaders.location !== undefined
          }
          ...
          const willFollow = hasLocation && request.redirect === 'follow' &&
        ...
        onUpgrade (status, rawHeaders, socket) {
          ...
          for (let n = 0; n < rawHeaders.length; n += 2) {
            const key = rawHeaders[n + 0].toString('latin1')
            const val = rawHeaders[n + 1].toString('latin1')
