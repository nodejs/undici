    ...
    context.dispatcher.dispatch(
      ...
      },
      {
        ...
        onHeaders (status, headersList, resume, statusText) {
          ...
          registry.register(stream, connection.abort, this)
          ...
          pullAlgorithm = async (controller) => {
            ...
            if (bytes === undefined) {
              ...
              this.context.off('terminated', onResponseAborted)
              this.context.off('terminated', onRequestAborted)
            ...
            if (controller[kError]) {
              this.context.terminate({ reason: controller[kError] })
              return
            }
