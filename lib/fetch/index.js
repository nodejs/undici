...
async function httpNetworkFetch (
  ...
  try {
    ...
    if (err.name === 'AbortError') {
      ...
      // 2. If error is ProxyAgent related, then pass it.
      if (err.message === 'Proxy response !== 200 when HTTP Tunneling') {
        return makeNetworkError(err.message)
      }

      // 3. Return the appropriate network error for fetchParams.
      return makeAppropriateNetworkError(fetchParams)
    }
