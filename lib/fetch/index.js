...
function httpNetworkFetch (
  ...
  return new Promise((resolve) => {
    ...
    // 15. Set up stream with pullAlgorithm set to pullAlgorithm, cancelAlgorithm set to
    // cancelAlgorithm, highWaterMark set to highWaterMark, and sizeAlgorithm set to
    // sizeAlgorithm.
    // NOTE: See onHeaders.
    ...
    if (forceNewConnection && context.abort) {
      context.abort()
    }
