...
function makePolicyContainer () {
  return {
    // A CSP list, which is a CSP list. It is initially empty. https://w3c.github.io/webappsec-csp/#csp-list
    CSPList: [],
    // An embedder policy, which is an embedder policy. It is initially a new embedder policy. https://html.spec.whatwg.org/multipage/origin.html#embedder-policy
    embedderPolicy: {
      value: 'unsafe-none',
      reportingEndpoint: '',
    ...
    // A referrer policy, which is a referrer policy. It is initially the default referrer policy. https://w3c.github.io/webappsec-referrer-policy/#referrer-policy
