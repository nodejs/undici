...
class Request {
  ...
  constructor (input, init = {}) {
    ...
    request = makeRequest({
      ...
      // window window.
      window,
      // internal priority request’s internal priority.
    ...
    if (init.priority !== undefined) {
      // 1. If request’s internal priority is not null, then update
      // request’s internal priority in an implementation-defined manner.
      if (request.internalPriority !== null) {
        // Note: undici does not implement priority.
      } else {
    ...
    // 29. Set this’s signal to a new AbortSignal object with this’s relevant
    // Realm.
    ...
    // 34. Let inputBody be input’s request’s body if input is a Request
