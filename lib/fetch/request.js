...
const { kHeaders, kSignal, kState, kGuard, kRealm, kType, kRequest } = require('./symbols')
...
class Request {
  ...
  constructor (input, init = {}) {
    ...
    const inputBody = input[kType] === kRequest ? input[kState].body : null
...
webidl.converters.Request = function (V, opts = {}) {
  if (opts.strict !== false && V[kType] !== kRequest) {
    throw webidl.errors.exception({
      header: 'Request',
      message: `Expected ${V} to be an instance of Request.`
    })
  }
