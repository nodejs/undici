...
class Response {
  ...
  get url () {
    ...
    url = length === 0 ? null : urlList[length - 1].toString()
  ...
  clone () {
    ...
    const clonedResponse = makeResponse(this[kState])
    clonedResponse.body = cloneBody(clonedResponse.body)
