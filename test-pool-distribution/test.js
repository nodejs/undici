...
const pool = new Pool('http://localhost:8080', { connections: 5 })

let totalRequests = 0
const backendStats = {}
const duration = 30000 // 30 seconds

console.log('Starting test - sending 1 request every 50ms for 30 seconds...')
console.log('Expected behavior: Even distribution across 5 backends')
console.log('Actual behavior: Uneven distribution (bug)\n')
...
setTimeout(() => {
  ...
  if (ratio > 2) {
    console.log('❌ UNEVEN DISTRIBUTION DETECTED - Bug reproduced!')
  } else {
    console.log('✓ Distribution is relatively even')
  }
